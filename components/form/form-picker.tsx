...
const FormPicker = ({
        ...
        const fetchImages = async() =>{
            try {
                ...
                if(result && result.response){
                    ...
                    console.log("failed to get images from the unsplash")
  ...
  return (
    <div className="relative overflow-y-auto h-[165px] scrollbar-thin scrollbar-thumb-rounded-lg">
        <div className="grid grid-cols-3 gap-2 mb-2 mr-1">
            {images.map((image)=>(
                <div
                key={image.id}
