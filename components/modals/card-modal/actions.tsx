...
const Actions = ({data}:ActionsProps ) => {
  ...
  return (
    <div className="space-y-2 mt-6 md:mt-2">
    <p className="text-sm font-normal flex gap-2"> <HammerIcon className="w-4 h-4"/>Actions</p>
    <Button
        onClick={onCopy}
    ...
    <Button
        ...
        variant="gray"
        className="w-full justify-start bg-red-300"
        size="inline"
    >
